El programa Igualmente Conectados se encarga de acortar la brecha digital que existe en nuestro país, Mumukilandia. Entre las tareas que desempeñan día a día para lograr cumplir este objetivo se encuentra la distribución de netbooks en todas las escuelas públicas del país, que es llevada a cabo por personas que llamaremos facilitadores.
...
En esta oportunidad, aprovecharemos todo lo que sabemos de Gobstones para escribir un pequeño sistema que nos permita simular el trabajo de un facilitador.
 ...
 ¿En Gobstones? Pero si lo único que se puede hacer es poner y sacar bolitas, ¡es imposible!
 ¡Grave error! En esta lección te vamos a mostrar como podemos usar las bolitas para modelar lo que se nos ocurra. Sólo vamos a necesitar un poquito de imaginación de tu parte y que nos ayudes a pensar buenos nombres para las tareas que programemos.
